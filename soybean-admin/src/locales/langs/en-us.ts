  ...
  page: {
    ...
    devices: {
      ...
      connect: {
        ...
        file: 'File transfer',
        mirror: 'Screen mirror (view only)',
        terminal: 'Terminal session',
        terminalHint: 'Opens RustDesk\u2019s built-in terminal. Requires Terminal permission enabled on the remote device.',
        launched: 'Opening {action} for {host} in your RustDesk client\u2026',
